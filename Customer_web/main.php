        ...
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="ASSETS/product pic/R.jpeg" alt="Mountain Landscape">
                    <div class="gallery-overlay">
                        <i class="bi bi-mountains"></i>
                        <h4>White Tea</h4>
                        <p>Delicate, smooth, and naturally sweet</p>
                    </div>
                </div>
                <div class="gallery-item">
                    <img src="ASSETS/product pic/OIP.jpeg" alt="Forest Scene">
                    <div class="gallery-overlay">
                        <i class="bi bi-tree"></i>
                        <h4>Oolong Tea</h4>
                        <p>Rich, aromatic, partially oxidized flavor</p>
                    </div>
                </div>
                <div class="gallery-item">
                    <img src="ASSETS/product pic/OIP (1).jpeg" alt="Ocean Waves">
                    <div class="gallery-overlay">
                        <i class="bi bi-water"></i>
                        <h4>Chamomile Tea</h4>
                        <p>Soothing, floral, caffeine-free relaxation</p>
                    </div>
                </div>
            </div>
        </div>
